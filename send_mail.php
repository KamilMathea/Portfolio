...
// Deine ALL-INKL E-Mail-Adresse als Absender und Empfänger
$siteEmail = "kontakt@kamil-mathea.de";
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'POST':
        ...
        // Mail headers für ALL-INKL
        $headers = [];
        $headers[] = 'MIME-Version: 1.0';
        $headers[] = 'Content-type: text/html; charset=utf-8';
        $headers[] = 'From: Portfolio Kontaktformular <' . $siteEmail . '>'; 
        $headers[] = 'Reply-To: ' . $email;
        $headers[] = 'Return-Path: ' . $siteEmail; 

        // Send mail mit -f Parameter für ALL-INKL Server
        $success = mail(
            $recipient,
            $subject,
            $mailBody,
